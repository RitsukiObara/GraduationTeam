...
//// リザルトがクリアの時
////====================================================
//void CFishShadow::ResultClear(void)
//{
...
//// リザルトが失敗の時
////====================================================
//void CFishShadow::ResultFail(void)
//{
//	CInputManager* pInputManager = CInputManager::GetInstance();
//
//	// 失敗の時
...
//// フェードする処理
////====================================================
//void CFishShadow::Fade(RESULT RESULT)
//{
...
//	switch (RESULT)
//	{
//	case CFishShadow::RESULT_CLEAR:
//
//		CGame::SetState(CGame::STATE_END);
//		pFade->SetFade(CScene::MODE_GAME);
//
//		break;
//	case CFishShadow::RESULT_FAIL:
//
//		m_state = STATE_OUT;
//		m_aPosDest[0].x = -RESULT_WIDTH;
//
