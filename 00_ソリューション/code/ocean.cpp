...
namespace
{
	...
	const int BGICE_CREATE_CNT_L = 200;				// 背景氷が生成される秒(左)
	const int BGICE_CREATE_CNT_R = 200;				// 背景氷が生成される秒(右)
	const int BGICE_CREATE_CNT_UP = 200;			// 背景氷が生成される秒(上)
	const int BGICE_CREATE_CNT_DOWN = 200;			// 背景氷が生成される秒(下)
}
