...
namespace
{
	...
	const int MAX_RANGE_RIGHT = 2000;				// ランダムレンジ右最大数
	const int MIN_RANGE_RIGHT = 1200;				// ランダムレンジ右最低数
	const float Z_UP = 1500.0f;						// Z方向上方向
	const float Z_DOWN = -1500.0f;					// Z方向下方向
	const int BGICE_CREATE_CNT_L = 250;				// 背景氷が生成される秒(左)
	const int BGICE_CREATE_CNT_R = 300;				// 背景氷が生成される秒(右)
